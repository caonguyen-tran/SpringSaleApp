<%-- 
    Document   : products
    Created on : Apr 18, 2024, 8:38:23 PM
    Author     : ACER
--%>
...
<form:form method="post" action="${action}" modelAttribute="product" enctype="multipart/form-data">
    ...
    <div class="form-floating mb-3 mt-3">
        ...
        <form:errors path="name" element="p" cssClass="alert alert-danger"/>
        <label for="name">Tên sản phẩm</label>
    </div>
    <div class="form-floating mb-3 mt-3">
        <form:input class="form-control"  id="price"  placeholder="Gía" path="price" />
        <form:errors path="price" element="p" cssClass="alert alert-danger"/>
